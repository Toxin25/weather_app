...
/*Dom elements*/
/*different components of a web page, each element refer tag in a doc*/
const searchBtn = document.querySelector('.searchBtn');
const cityNameInput = document.querySelector('.citySearch');
const apiKey = '19f38dcd2969cfadf52a1bd64821244b';
...
const gettingStartedBtn = document.querySelector('.getting-started-btn'); /*data in html display or occurs null*/


/*button event listner*/
/* "getting started button, adds elemts with the classes'frontpage'" */
...
/*enter key in the city name input*/
/*it programmically triggers a click on a search button*/
...
/*function takes parameters like city name, weather data,index, and returns HTML template strings for creating weather cards*/
...
searchBtn.addEventListener('click', function () {
    ...
    if (cityName == "") {
        ...
        fetch(geocoding_api_url).then(res => res.json()).then(data => {
            ...
            /*handel errors during coding API request*/
